...
mods <- list(aidregvdc, pubtransregvdc, ngoregvdc, remregvdc, migregvdc, loanregvdc)
...
h0 <- optbw("consumption", b = "dist_2_seg13", df = df.hh, fuzzy = TRUE, dist.exclude = "none")[1,1]

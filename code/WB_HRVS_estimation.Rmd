...
df.hh <- filter(df.hh, !is.na(total_income), !is.na(home_investment), !is.na(productive_assets), 
  ...
  mutate(dist_pos1 = if_else(dist_2_seg1>0, dist_2_seg1, 0),
         ...
         reconstruction_aid_cumulative = reconstruction_aid_cumulative/10000,
         aid_cumulative = aid_cumulative/10000,
...
dist.exclude = "none"; k = "triangular"; vce = "hc1"; bvar = "dist_2_seg1pt"; fvar = "reconstruction_aid_cumulative";
...
plotvar(fvar, b = bvar, df = df.hh, dist.exclude = dist.exclude, poly = FALSE, method = "loess") + 

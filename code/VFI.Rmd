...
b <- optbw("food_consumption", b = "dist_2_seg13", df = df.hh, fuzzy = TRUE, dist.exclude = "none", vars = "opt")[1,3]
...
iterplotter(V, xidx = finalV$x[1650], var = "ifx")
...
#library(rayshader)
threedplotter(V, "Tw", ubm = 30, ubh = 30, lbm = -1, lbh = 0, d3 = FALSE, theta = theta, ) +
  geom_contour(aes(x = x, y = h, z = -1*log(-proj)), color = "grey") + 
  geom_rug(data = qdat, aes(x = qx, y = qh), inherit.aes = FALSE, color = "red") + theme_bw()
pcfx = threedplotter(V, "cfx", d3 = FALSE, ubm = 30, ubh = 30, lbm = -1, lbh = 0,
                     method = "neuralnet", theta = theta) + theme_bw() + theme(text = element_text(size = 17)) + 
  labs(x = "Wealth", y = "Housing Stock", fill = "Consumption") +
  geom_contour(aes(x = x, y = h, z = proj), color = "grey") + 
  geom_rug(data = qdat, aes(x = qx, y = qh), inherit.aes = FALSE, color = "red") + theme_bw()
pifx = threedplotter(V, "ifx", d3 = FALSE, ubm = 30, ubh = 30, lbm = -1, lbh = 0, 
                     method = "neuralnet", theta = theta) + theme_bw() + theme(text = element_text(size = 17)) + 
...
p = threedplotter(V, "aidcfx", d3=FALSE, aidamt = 1, ubm = 3.5, ubh = 15, lbm = -.5, method = "neuralnet", lbh = 0, theta = theta) 
p1 = p +
...
p = threedplotter(V, "aidifx", d3=FALSE, aidamt = 1, ubm = 3.5, ubh = 15, lbm = -.5, method = "neuralnet", lbh = 0, theta = theta)
p2 = p + 
...
ggplot() +
  ...
  geom_density(aes(x = df.hh$imputed_bufferstock*df.hh$M_avg), color = "red", position = "identity") + 
  #geom_density(aes(x = df.hh$x_noaid*df.hh$M_avg + ), color = "blue", position = "identity") + 
  xlim(-5e5, 1.5e6)

...
cfacts <- do.call(rbind, cfacts)*df.bord$E_Y
...
-1*weighted.mean(df.hh$borrowing_delta[df.hh$received_aid==1], df.hh$wt_hh[df.hh$received_aid==1]) ### Borrowing is actually lending
```
